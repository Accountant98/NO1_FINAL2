...
def create_cadics_new(case, market, powertrain, car, list_group):
    ...
    # frame_data.to_excel("cadic_new.xlsx", index=None, header=None)
...
def pick_car(data_karenhyo, dict_except_config, cadic_no, adddress_config, group, lot, data_spec, 
    ...
    # if lot=="VC" and cadic_no=="mstr-013-0178000":
            ...
            for index in col_index_zone_picked:
                ...
                for item in address_zone[zone]:
                    if item[0]==index:
                        ...
                        break
                #=======================================================================================================
                adddress_config_zone,dict_grade_zone,dict_zone_conf_dk=get_config_zone(adddress_config,zone,dict_grade,list_except_config,condition_zone)
                ...
                #======================================================================================================
                    ...
                    dict_car=check_option_new("xxx", data_spec, frame_option, dict_zone_conf_dk)
                    ...
                    #     print("vcc:",dict_car_add_infor)


                    list_dict_data, index_cadic= case_have_option(dict_car_add_infor,adddress_config_zone,group,col_group, col_evaluate, col_comment,cadic_no,index_cadic,lot )
